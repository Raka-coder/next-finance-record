    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* <p className="text-sm text-muted-foreground">
            Untuk mengubah nama lengkap dan username, gunakan menu profil di header.
          </p> */}
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* <Alert>
            ...
            <AlertDescription>
              <strong>Impor Data:</strong> Fitur ini memungkinkan Anda mengimpor transaksi dari file CSV. Pastikan
              format file sesuai dengan template yang disediakan. Fitur ini akan segera tersedia.
            </AlertDescription>
          </Alert> */}
          ...
          <div className="space-y-3">
            ...
            <AlertDescription className="border rounded-lg p-4 space-y-2">
              ...
              {/* <li className="text-sm text-blue-700">Encoding UTF-8 dengan BOM untuk kompatibilitas Excel</li> */}
              <li className="text-sm text-muted-foreground">
          ...
          {/* <Button
            ...
            onClick={() => {
              if (
                ...
                alert("Fitur hapus semua data akan segera tersedia!");
              }
            }}
          >
            Hapus Semua Data
